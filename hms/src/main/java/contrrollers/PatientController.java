...
public class PatientController extends Controller {
    ...
    private void accessPersonalMedicalRecord() {
        ...
        System.out.println("Would you like to update your contact information? (yes/no):");
    ...
    private void updatePersonalInformation() {
        ...
        boolean success = medicalRecordService.updatePersonalInformation(patientUser.getUserId(), contactInfo);
        if (success) {
