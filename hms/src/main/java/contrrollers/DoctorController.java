...
public class DoctorController extends Controller {
    ...
    public DoctorController(User doctorUser, AppointmentService appointmentService,
                            ...
                            DoctorScheduleService doctorScheduleService, UserService userService) {
    ...
    private void updateAppointmentStatus() {
        ...
        // Assuming we handle the first match
        ...
        System.out.println("Enter new status (pending/confirmed/completed):");
