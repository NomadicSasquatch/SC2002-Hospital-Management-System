...
public class AdminController extends Controller {
     ...
     *
     * @param adminUser          the admin user associated with this controller
    ...
    private void updateStaffMember() {
        ...
        if (existingUser == null || (!existingUser.getRole().equalsIgnoreCase("Doctor")
                && !existingUser.getRole().equalsIgnoreCase("Pharmacist"))) {
