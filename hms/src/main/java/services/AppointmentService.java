...
public List<Appointment> rescheduleAppointment(String appointmentId, String newDate, String newTime) {
    ...
    // Process the first matching appointment (if multiple matches are possible)
    ...
    appointment.setStatus("pending"); // Reset status to pending for doctor's approval
    ...
    public boolean cancelAppointment(String appointmentId) {
        ...
        // Assuming we only cancel the first matching appointment
        Appointment appointment = appointments.get(0);
