...
public class MedicalRecordService {
    ...
    /**
     * Updates personal information in a medical record.
     *
     * @param patientId     The patient's ID.
     * @param contactInfo   The new contact information.
     * @return True if the update was successful.
     */
    public boolean updatePersonalInformation(String patientId, String contactInfo) {
        ...
        // Assuming we handle the first matching record
    ...
    public boolean addDiagnosis(String doctorId, String patientId, String diagnosis) {
        // Verify doctor exists and has the appropriate role
        List<User> doctors = userRepository.getDataById(doctorId);
        if (doctors.isEmpty() || !doctors.get(0).getRole().equalsIgnoreCase("Doctor")) {
